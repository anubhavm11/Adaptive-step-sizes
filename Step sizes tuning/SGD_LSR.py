...
for gamma in step:
	...
	plt.semilogy(np.linspace(0,epochs,len(lossHistorySGD),endpoint=False) , (np.array(lossHistorySGD)-loss_MLE)/N,label="Step size ={}".format(gamma),color=cmap[step.index(gamma)])
