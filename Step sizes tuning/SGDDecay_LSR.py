...
step=[0.001,0.005,0.01,0.02,0.05,0.1,0.2,0.5,1.0,2.0]
...
for gamma in step:
	...
	plt.semilogy(np.linspace(0,epochs,len(lossHistorySGDDecay),endpoint=False) , (np.array(lossHistorySGDDecay)-loss_MLE)/N,'b',label="Step size ={}".format(gamma),color=cmap[step.index(gamma)])
